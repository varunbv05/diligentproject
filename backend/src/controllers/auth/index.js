...
const Logout = async (req, res, next) => {
    try {
        ...
        // Remove refresh token from memory (same place as jwt.js: refreshTokenStore)
        const { refreshTokenStore } = require("../../helpers/jwt");
        const deleted = delete refreshTokenStore[user_id];
